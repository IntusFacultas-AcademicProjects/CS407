...
urlpatterns = [
    ...
    url(r'^auditioner/(?P<pk>[0-9+]+)$', views.AuditionProfileView.as_view(), name='audition-profile'),
    url(r'^agent/(?P<pk>[0-9+]+)$', views.CastingProfileView.as_view(), name='casting-profile')
